...
Examples:
	| name             | dob        | date       | weight | length | head | smoking | note                                                                                      |
...
Examples:
	| name          | dob        | date       | weight | height | sys | dia | houseSmoking | patientSmoking | HDL | LDL | triglycerides | note                                                                            |
...
Examples:
	| name            | dob        | date       | weight | height | sys | dia | houseSmoking | note                                                                            |
